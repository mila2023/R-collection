library(openmeteo)
library(data.table)
jpeg("C:/Users/kamil/RProjects/PD2/Pogoda/kukurydza_zach_SUN.jpeg", width = 1000)
...
axis(2,at = seq(0, 450, by = 25),las = 1, cex.axis=1.3)
grid(0, 18, col = "lightgray")

box("plot")
legend(43.8,450,cex = 1.2 ,fill = c("#A2FF00","#78A922","#384E12"),density = c(5,10,15),legend = c("rok 2021","rok 2022","rok 2023"))
dev.off()
